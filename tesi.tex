...
\input{capitoli/capitolo-2}             % Il contesto del process mining
\input{capitoli/capitolo-3}             % Modalità di svolgimento dello stage
\input{capitoli/capitolo-4}             % Indici di prestazione dello stage
